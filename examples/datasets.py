...
if __name__ == "__main__":
    ...
    #If xs=True you get the xs for each sequence before splitting into train/val/test.
    sequences,vocab,total_xs=build_flickr_sequences(flickr_data,xs=True)
    seqs_train,seqs_val,seqs_test,xs_train,xs_val,xs_test=split_seq_data(sequences,vocab,train_percent=0.7,val_percent=0.3,test_percent=0.0)